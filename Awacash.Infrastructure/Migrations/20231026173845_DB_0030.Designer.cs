...
namespace Awacash.Infrastructure.Migrations
{
    ...
    [Migration("20231026173845_DB_0030")]
    partial class DB_0030
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.AuditLog", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.BvnInfo", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("EnrollBankCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LgaOfCapture")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("StateOfCapture")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.Document", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("VerificationTrial")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.Referral", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.Saving", b =>
                {
                    ...
                    b.Property<string>("DeductionAccount")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SavingAccount")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Awacash.Domain.Entities.Referral", b =>
                {
                    b.HasOne("Awacash.Domain.Entities.Customer", "ReferredCustomer")
                        .WithMany("Referrals")
