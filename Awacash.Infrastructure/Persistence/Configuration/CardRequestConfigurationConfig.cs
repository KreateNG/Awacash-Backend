...
{
    public class CardRequestConfigurationConfig : IEntityTypeConfiguration<CardRequestConfiguration>
    {
        public void Configure(EntityTypeBuilder<CardRequestConfiguration> builder)
        {
